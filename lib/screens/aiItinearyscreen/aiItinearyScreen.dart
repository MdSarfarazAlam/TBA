...
class AIIinearyScreen extends StatefulWidget {
  String link, text;
  AIIinearyScreen({super.key, required this.link, required this.text});

  @override
  State<AIIinearyScreen> createState() => _AIIinearyScreenState();
}

class _AIIinearyScreenState extends State<AIIinearyScreen> {
